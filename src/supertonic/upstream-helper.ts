// @ts-nocheck
// Adapted from Supertone Supertonic nodejs/helper.js (MIT License).
// Upstream: https://github.com/supertone-inc/supertonic/blob/main/nodejs/helper.js
// Kept as an internal module so synthesis runs in this CLI's short-lived worker.
import fs from 'fs';
